...
class CustomDialog extends StatelessWidget {
  ...
  final bool fromPaymentController;

  CustomDialog({Key? key, this.payment, required this.fromPaymentController})
      : super(key: key);
  ...
  dialogContent(BuildContext context) {
    return Stack(
      children: [
        Container(
          padding:
              EdgeInsets.only(top: 66.0, bottom: 16.0, left: 5.0, right: 5.0),
          ...
          child: fromPaymentController == true
              ? Padding(
                  padding: const EdgeInsets.all(10.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
